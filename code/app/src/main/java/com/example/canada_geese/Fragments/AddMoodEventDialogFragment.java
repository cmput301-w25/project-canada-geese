...
/**
                ...
                uri -> {
                    if (uri != null) {
                        try {
                            ...
                            // Convert URI to Bitmap for storage
    ...
    private void addImageToGallery(Bitmap imageBitmap) {
        // Add to the collection
        selectedImages.add(imageBitmap);

        // Create an ImageView to display this image
        ...
        // Add click listener to remove the image when clicked
        imageView.setOnClickListener(v -> {
            imagesContainer.removeView(imageView);
            selectedImages.remove(imageBitmap);
